...
public class puntaje {
	...
	public String consultarValoraciones()
	{
		...
		Conexion con=new Conexion();
		String tabla="<table border=2><th bgcolor=\"#000000\" , style=\"border: solid 4px black; font-size: 30px;\">Id</th><th bgcolor=\"#779BE7\" , style=\"border: solid 4px black; font-size: 30px;\">Nombre</th>"
				+ "<th bgcolor=\"#000000\" , style=\"border: solid 4px black; font-size: 30px;\">Puntuacion</th><th bgcolor=\"#779BE7\" , style=\"border: solid 4px black; font-size: 30px;\">Sugerencia</th>";
		ResultSet rs=null;
		rs=con.Consulta(sql);
		try {
			while(rs.next())
