package com.resultado.puntuacion;

import java.sql.PreparedStatement;
import java.sql.ResultSet;
import java.sql.SQLException;

import com.resultado.Conexion.Conexion;
import com.resultado.puntuacion.usuario;
import com.resultado.Conexion.*;
public class puntuacion{
	...
	public String consultarTodo()
	{
		String sql="SELECT id_us,notafinal,tb_usuarios.nombre_us FROM tb_notas,tb_usuarios WHERE tb_notas.id_no=tb_usuarios.id_us AND tb_notas.nombre_us=tb_usuarios.nombre_us ORDER BY notafinal DESC LIMIT 10;"
				+ " ";
		Conexion con=new Conexion();
		String tabla="<table border=3><th bgcolor=\\\"#FFFFFF\\\" , style=\\\"border: solid 4px black; font-size: 70px;\\\">Calificacion</th>"
				+ "<th bgcolor=\\\\\\\"#FFFFFF\\\\\\\" , style=\\\\\\\"border: solid 4px black; font-size: 50px;\\\\\\\">Usuario</th>"
				+ "<th bgcolor=\\\"#FFFFFF\\\" , style=\\\"border: solid 4px black; font-size: 100px;\\\">Foto</th>";
		ResultSet rs=null;
		...
		try {
			while(rs.next())
			{
				tabla+="<tr><td bgcolor=\\\\\\\"#FFFFFF\\\\\\\" style=\\\"border: solid 4px black;\\\"><p style=\\\"color:black\\\">"+rs.getInt(2) +"</td>"
						+ "<td bgcolor=\\\\\\\"#FFFFFF\\\\\\\" style=\\\"border: solid 4px black;\\\"><p style=\\\"color:black\\\">"+rs.getString(3) +"</td>"
